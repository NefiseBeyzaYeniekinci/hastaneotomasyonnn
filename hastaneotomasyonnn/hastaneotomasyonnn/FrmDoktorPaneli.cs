...
namespace hastaneotomasyonnn
{
    public partial class FrmDoktorPaneli : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("insert  into Tbl_Doktorlar(DoktorAd,DoktorSoyad,DoktorBrans,DoktorTC,DoktorSifre) values (@d1,@d2,@d3,@d4,4)", bgl.baglanti());
